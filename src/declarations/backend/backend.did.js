export const idlFactory = ({ IDL }) => {
  ...
  const Result_10 = IDL.Variant({ 'ok' : ChannelId, 'err' : Error });
  ...
  const Result_9 = IDL.Variant({ 'ok' : RuleId, 'err' : Error });
  ...
  const Result_8 = IDL.Variant({ 'ok' : IDL.Vec(Channel), 'err' : Error });
  ...
  const Result_7 = IDL.Variant({ 'ok' : IDL.Vec(Message), 'err' : Error });
  ...
  const Result_6 = IDL.Variant({ 'ok' : IDL.Vec(Rule), 'err' : Error });
  const Result_5 = IDL.Variant({ 'ok' : Channel, 'err' : Error });
  const Result_4 = IDL.Variant({ 'ok' : Message, 'err' : Error });
  const Result_3 = IDL.Variant({ 'ok' : Rule, 'err' : Error });
  ...
  return IDL.Service({
    ...
    'getAllChannels' : IDL.Func([], [Result_8], ['query']),
    'getAllMessages' : IDL.Func([], [Result_7], ['query']),
